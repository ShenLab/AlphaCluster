...
python denovonear/__main__.py poisson --in $disease.results_$tag/$gene/$size.$gene.$disease.released.hg38.$SLURM_JOB_ID.txt --N $size --protein $gene --out $disease.results_$tag/$gene/$size.$gene.$disease.gMVP0.85.poisson_pvalue.$SLURM_JOB_ID.txt  --scores /share/terra/rsrc/hg38/gMVP/gMVP_hg38.2021-02-28.txt.gz --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa --threshold .85 --score_col 14
...
#3D with CADD score scaling and enrichment
python denovonear/__main__.py cluster --in $disease.results_$tag/$gene/$size.$gene.$disease.released.hg38.$SLURM_JOB_ID.txt --protein_dir proteins --protein $gene --runs 10000000 --pvalues_in $enrich_pvalues_file --out $disease.results_$tag/$gene/$size.$gene.$disease.3d.CADDscaled.enrich.$SLURM_JOB_ID.out --scores  /share/terra/rsrc/hg38/cadd/cadd_1.6/whole_genome_SNVs.tsv.gz --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa --scale --score_col 5
...
python denovonear/__main__.py cluster --in $disease.results_$tag/$gene/$size.$gene.$disease.released.hg38.$SLURM_JOB_ID.txt --protein_dir proteins --protein $gene --runs 10000000 --pvalues_in $disease.results_$tag/$gene/$size.$gene.$disease.gMVP0.85.poisson_pvalue.$SLURM_JOB_ID.txt --out $disease.results_$tag/$gene/$size.$gene.$disease.3d.gMVPthreshold0.85.$SLURM_JOB_ID.out --scores /share/terra/rsrc/hg38/gMVP/gMVP_hg38.2021-02-28.txt.gz --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa --threshold .85 --score_col 14
...
#3D with gMVP threshold 0.85 and scale scoring
python denovonear/__main__.py cluster --in $disease.results_$tag/$gene/$size.$gene.$disease.released.hg38.$SLURM_JOB_ID.txt --protein_dir proteins --protein $gene --runs 10000000 --pvalues_in $disease.results_$tag/$gene/$size.$gene.$disease.gMVP0.85.poisson_pvalue.$SLURM_JOB_ID.txt --out $disease.results_$tag/$gene/$size.$gene.$disease.3d.gMVPscaled.gMVPthreshold0.85.$SLURM_JOB_ID.out --scores /share/terra/rsrc/hg38/gMVP/gMVP_hg38.2021-02-28.txt.gz --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa --threshold 0.85 --scale --score_col 14
