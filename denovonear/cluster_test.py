...
from denovonear.simulate import get_p_value, get_p_value_1d
...
async def cluster_de_novos(symbol, de_novos, three_d_locations, ensembl, iterations=1000000, mut_dict=None):
    ...
    for transcript in transcripts:
        ...
        (miss_dist, miss_prob) = get_p_value(transcript, rates, three_d_locations, iterations, "missense", missense_events)
        (nons_dist, nons_prob) = get_p_value(transcript, rates, three_d_locations, iterations, "lof", nonsense_events)
...
async def cluster_de_novos_1d(symbol, de_novos, ensembl, iterations=1000000, mut_dict=None):
    """ analysis proximity cluster of de novos in a single gene
    ...
    for transcript in transcripts:
        ...
        (miss_dist, miss_prob) = get_p_value_1d(transcript, rates, iterations, "missense", missense_events)
        (nons_dist, nons_prob) = get_p_value_1d(transcript, rates, iterations, "lof", nonsense_events)
