...
python alphacluster/__main__.py cluster_1d --in data/asd.released.hg38.txt --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out ASD_new/$gene.1d.out

#python alphacluster/__main__.py cluster_1d --in data/asd.released.hg38.txt --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out ASD_new/$gene.1d.gMVP.out

python alphacluster/__main__.py cluster --in data/asd.released.hg38.txt --protein_dir proteins --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out ASD_new/$gene.3d.out --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa
...
python alphacluster/__main__.py poisson --in data/asd.released.iid.hg3d.txt --N 23425 --protein $gene --out data/$SLURM_JOB_ID/REVEL0.5.poisson_pvalue.txt  --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa --dbNSFP scores/dbNSFP4.2a_grch38.gz --dbNSFP_annotator REVEL_score --threshold 0.5

python alphacluster/__main__.py cluster --in data/asd.released.iid.hg38.txt --protein_dir proteins --protein $gene --runs 90000000 --pvalues_in data/$SLURM_JOB_ID/REVEL0.5.poisson_pvalue.txt --out results/$SLURM_JOB_ID/$gene.3d.REVEl.threshold0.5.out --dbNSFP scores/dbNSFP4.2a_grch38.gz --dbNSFP_annotator REVEL_score --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa --threshold 0.5
...
python alphacluster/__main__.py cluster --in data/asd.released.hg38.txt --protein_dir proteins --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out results/$SLURM_JOB_ID/$gene.3d.out --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa
