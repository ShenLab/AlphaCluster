...
python denovonear/__main__.py cluster_1d --in data/asd.released.hg38.txt --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out ASD_known/$gene.1d.out

#python denovonear/__main__.py cluster_1d --in data/asd.released.hg38.txt --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out ASD_known/$gene.1d.gMVP.out

python denovonear/__main__.py cluster --in data/asd.released.hg38.txt --protein_dir proteins --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out ASD_known/$gene.3d.out --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa
