...
python alphacluster/__main__.py cluster_1d --in data/power/$SLURM_JOB_ID.$count.asd.released.hg38.txt --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out ASD_power/$gene/$gene.$SLURM_JOB_ID.1d.out

python alphacluster/__main__.py cluster --in data/power/$SLURM_JOB_ID.$count.asd.released.hg38.txt --protein_dir proteins --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out ASD_power/$gene/$gene.$SLURM_JOB_ID.3d.out --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa

python alphacluster/__main__.py cluster --in data/power/$SLURM_JOB_ID.$count.asd.released.hg38.txt --scores /share/terra/rsrc/hg38/gMVP/gMVP_hg38.2021-02-28.txt.gz --protein_dir proteins --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out ASD_power/$gene/$gene.$SLURM_JOB_ID.3d.gMVP.out --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa

python alphacluster/__main__.py cluster --in data/power/$SLURM_JOB_ID.$count.asd.released.hg38.txt --protein_dir proteins --protein $gene --runs 90000000 --pvalues_in data/asd_released_pvalues.txt --out ASD_power/$gene/$gene.$SLURM_JOB_ID.3d.REVEL.out --dbNSFP scores/dbNSFP4.2a_grch38.gz --dbNSFP_annotator REVEL_rankscore --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa
