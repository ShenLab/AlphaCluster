...
python alphacluster/__main__.py cluster_1d --in data/ndd.released.hg38.txt --protein $gene --runs 90000000 --pvalues_in data/ndd_released_pvalues.txt --out NDD_new/$gene.1d.out
...
python alphacluster/__main__.py cluster --in data/ndd.released.hg38.txt --protein_dir proteins --protein $gene --runs 90000000 --pvalues_in data/ndd_released_pvalues.txt --out NDD_new/$gene.3d.out --gencode data/gencode.v38.annotation.gtf.gz --fasta data/genome.hg38rg.fa
