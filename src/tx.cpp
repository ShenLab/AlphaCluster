...
std::string Tx::get_codon_sequence(){
  return translate(cds_sequence);
}
...
int Tx::get_codon_number(int bp){
  return get_codon_info(bp).codon_number;
}
...
Codon Tx::get_codon_info(int bp) {
    ...
    */
	...
	//std::cout<< "codon_number= "<< codon_number<<std::endl;
	//std::cout<< "intra_codon= "<< intra_codon<<std::endl;

	//std::cout<< "codon_seq= "<< codon_seq<<std::endl;	
